...
// Conecta o socket enquanto há sessão e o desconecta no logout. Componentes
// não escutam o socket diretamente — assinam invalidação por recurso via
// useRealtimeInvalidate (web/src/hooks/useRealtimeInvalidate.js), que usa
// subscribeInvalidate exposto aqui.
export function RealtimeProvider({ children }) {
  ...
  useEffect(() => {
    ...
    // tomar 401 SESSION_REVOKED (ver src/realtime/index.js:emitSessaoRevogada).
