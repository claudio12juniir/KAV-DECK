...
export const getById = asyncHandler(async (req, res) => {
  const transportadora = await service.getById({ empresaId: req.user.empresaId, id: req.params.id });
  res.json(transportadora);
});

export const create = asyncHandler(async (req, res) => {
  const transportadora = await service.create({ empresaId: req.user.empresaId, data: req.body });
...
export const update = asyncHandler(async (req, res) => {
  ...
  const transportadora = await service.update({
    empresaId: req.user.empresaId,
    id: req.params.id,
    data: req.body,
  });
