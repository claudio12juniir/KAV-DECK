...
import { createRotaEntregaSchema, updateRotaEntregaSchema } from "./schema.js";
...
router.post("/", requireRole("ADMIN", "GESTOR"), validate({ body: createRotaEntregaSchema }), controller.create);
router.patch(
  "/:id",
  requireRole("ADMIN", "GESTOR"),
  validate({ params: idParamSchema, body: updateRotaEntregaSchema }),
  controller.update,
);
