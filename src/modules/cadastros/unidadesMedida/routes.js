...
import { createUnidadeMedidaSchema, updateUnidadeMedidaSchema } from "./schema.js";
...
router.post(
  ...
  validate({ body: createUnidadeMedidaSchema }),
  controller.create,
);
router.patch(
  "/:id",
  requireRole("ADMIN", "GESTOR"),
  validate({ params: idParamSchema, body: updateUnidadeMedidaSchema }),
  controller.update,
);
