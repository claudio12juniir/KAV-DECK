...
import { createCategoriaSchema, updateCategoriaSchema } from "./schema.js";
...
router.post("/", requireRole("ADMIN", "GESTOR"), validate({ body: createCategoriaSchema }), controller.create);
router.patch(
  "/:id",
