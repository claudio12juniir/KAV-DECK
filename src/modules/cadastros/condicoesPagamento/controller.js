...
const ENTIDADE = "condicao-pagamento";
...
export const getById = asyncHandler(async (req, res) => {
  const condicao = await service.getById({ empresaId: req.user.empresaId, id: req.params.id });
  res.json(condicao);
});

export const create = asyncHandler(async (req, res) => {
  const condicao = await service.create({ empresaId: req.user.empresaId, data: req.body });
...
export const update = asyncHandler(async (req, res) => {
  ...
  const condicao = await service.update({ empresaId: req.user.empresaId, id: req.params.id, data: req.body });
