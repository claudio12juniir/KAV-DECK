...
import { createContaBancariaSchema, updateContaBancariaSchema } from "./schema.js";
...
router.post(
  ...
  validate({ body: createContaBancariaSchema }),
  controller.create,
);
router.patch(
  "/:id",
  requireRole("FINANCEIRO", "ADMIN"),
  validate({ params: idParamSchema, body: updateContaBancariaSchema }),
  controller.update,
);
