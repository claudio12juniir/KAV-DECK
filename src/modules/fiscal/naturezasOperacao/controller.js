...
const ENTIDADE = "natureza-operacao";
...
export const getById = asyncHandler(async (req, res) => {
  const natureza = await service.getById({ empresaId: req.user.empresaId, id: req.params.id });
  res.json(natureza);
});

export const create = asyncHandler(async (req, res) => {
  const natureza = await service.create({ empresaId: req.user.empresaId, data: req.body });
  await auditarCriacao({
    empresaId: req.user.empresaId,
    entidade: ENTIDADE,
    entidadeId: natureza.id,
...
export const update = asyncHandler(async (req, res) => {
  ...
  const natureza = await service.update({ empresaId: req.user.empresaId, id: req.params.id, data: req.body });
